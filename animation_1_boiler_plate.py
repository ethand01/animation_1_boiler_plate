...
# import assets
sprite_sheet = pygame.image.load("shark.png").convert_alpha() # add the path/name of your sprite sheet file

# get details about individual sprites
total_sprites = 5 # code the number of sprite images your sprite sheet has
